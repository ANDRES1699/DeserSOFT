...
<div class="menu">
 ...
 <hr>
    <div class="cabeza">       
        ...
        <div class="infor">
                <i class="submenu"id="nom" onclick="menutoggle('conten')"><?= $_SESSION['Enfermera']['nombre'] ?><i class="fas fa-angle-down" ></i></i>
...
<hr>
    <div class="cuerpo">
        <ul class="list-group">
            <li><i class="fas fa-book-reader"></i><a href="">Justificaciones</a></li>       
        </ul>
    </div>
